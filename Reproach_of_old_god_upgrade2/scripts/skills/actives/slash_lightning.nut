		...
		ret.extend([
			{
				...
				text = "Inflicts an additional [color=" + this.Const.UI.Color.DamageValue + "]20[/color] - [color=" + this.Const.UI.Color.DamageValue + "]30[/color] damage that ignores armor to up to three targets"
			},
			{
				id = 7,
				type = "text",
