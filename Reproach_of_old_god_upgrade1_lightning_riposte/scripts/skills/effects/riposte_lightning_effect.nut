this.riposte_lightning_effect <- this.inherit("scripts/skills/skill", {
	...
	function create()
	{
		...
		this.m.Description = "This character is prepared to immediately counter-attack on any failed attempt to attack him in melee. This counter-attack inflicts lightning damage to a single target.";
